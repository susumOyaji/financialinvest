...
#if __has_include(<root_checker/RootCheckerPlugin.h>)
#import <root_checker/RootCheckerPlugin.h>
#else
@import root_checker;
#endif
...
#if __has_include(<flutter_nano_ffi/FlutterNanoFfiPlugin.h>)
#import <flutter_nano_ffi/FlutterNanoFfiPlugin.h>
#else
@import flutter_nano_ffi;
#endif
...
+ (void)registerWithRegistry:(NSObject<FlutterPluginRegistry>*)registry {
  ...
  [RootCheckerPlugin registerWithRegistrar:[registry registrarForPlugin:@"RootCheckerPlugin"]];
  [UniLinksPlugin registerWithRegistrar:[registry registrarForPlugin:@"UniLinksPlugin"]];
  [FLTDeviceInfoPlugin registerWithRegistrar:[registry registrarForPlugin:@"FLTDeviceInfoPlugin"]];
  [FilePickerPlugin registerWithRegistrar:[registry registrarForPlugin:@"FilePickerPlugin"]];
  [FLTFirebaseMessagingPlugin registerWithRegistrar:[registry registrarForPlugin:@"FLTFirebaseMessagingPlugin"]];
  [FlutterNanoFfiPlugin registerWithRegistrar:[registry registrarForPlugin:@"FlutterNanoFfiPlugin"]];
